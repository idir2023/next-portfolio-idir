...
const Home = () => {
  ...
  const services = [
    { id: 2, name: t('services.websiteDev'), description: t('services.websiteDevDesc'), icon: '/images/service-website.svg' },
    { id: 3, name: t('services.webAppDev'), description: t('services.webAppDevDesc'), icon: '/images/service-webapps.svg' },
    { id: 4, name: t('services.responsiveDesign'), description: t('services.responsiveDesignDesc'), icon: '/images/service-rwd.svg' },
    { id: 5, name: t('services.performance'), description: t('services.performanceDesc'), icon: '/images/service-performance.svg' },
  ];
      ...
      <AppShell hero>
        ...
        <AppSection title={t('home.projectsCompleted')}>
          ...
          <div className="text-center py-7">
            ...
            >
              {t('home.showAllProjects')} <i className="fas fa-chevron-right" />
            </Link>
          </div>
        </AppSection>
      </AppShell>
