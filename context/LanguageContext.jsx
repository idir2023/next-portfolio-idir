...
const translations = {
  en: {
    ...
    home: {
      ...
      testimonialsSubtitle: 'Feedback from people I have worked with.',
  ...
  fr: {
    ...
    home: {
      ...
      testimonialsSubtitle: 'Les retours des personnes avec qui j\'ai travaillé.',
    ...
    about: {
      ...
      myHistoryDesc: "Je m'appelle Lahcen Idir. Je viens du Maroc et j'ai 26 ans. Je suis développeur web spécialisé en PHP Laravel. Actuellement, je travaille en tant que stagiaire chez Mandi Tech Info, une entreprise au Maroc, depuis 8 mois.",
  ...
  ar: {
    ...
    home: {
      ...
      testimonialsSubtitle: 'آراء الأشخاص الذين عملت معهم.',
    ...
    about: {
      ...
      badge: 'عنواني',
      myHistory: 'قصتي',
      myHistoryDesc: 'اسمي لحسن إيدير. عمري 26سنة من المغرب. مطور ويب متخصص في PHP Laravel. حالياً أعمل كمتدرب في شركة Mandi Tech Info في المغرب منذ 8 أشهر.',
